...
var express = require('express'),
  ...
  exports.indexRouter= function () {
    ...
    indexRouter.route('/gant')
        .get(controllers.gant)
    indexRouter.route('/task')
        .get(controllers.task)
        .post(controllers.task)
    indexRouter.route('/api/task/*')
        .put(controllers.task)
    indexRouter.route('/api/link')
        .post(controllers.task)
        .put(controllers.task)
    indexRouter.route('/api/link/:id')
        .delete(controllers.task)
    indexRouter.route('/img')
        .get(controllers.img)
    indexRouter.route('/')
